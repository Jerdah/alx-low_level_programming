...
/**
 * _close - close a file descriptor and print an error if fail
 * @fd: file descriptor
 */
void _close(int fd)
{
...
/**
 * _read - read from a file and print an error if fail
 * @fd: file descriptor
 * @buf: buffer
 * @count: no of bytes
 */
 ...
 * @buffer: string containing the address to the entry point
