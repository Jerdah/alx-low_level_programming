...
#### [0-main.c](https://github.com/Jerdah/alx-low_level_programming/blob/master/0x03-debugging/0-main.c), [main.h](https://github.com/Jerdah/alx-low_level_programming/blob/master/0x03-debugging/main.h) 

- In most projects, we often give you only one main file to test with. For example, this main file is a test for a `postitive_or_negative()` function similar to the one you worked with in [an earlier C project]([0-positive_or_negative.c](https://github.com/Jerdah/alx-low_level_programming/blob/master/0x01-variables_if_else_while/0-positive_or_negative.c)
...
#### [1-main.c](https://github.com/Jerdah/alx-low_level_programming/blob/master/0x03-debugging/1-main.c) - Copy this main file. Comment out (don’t delete it!) the part of the code that is causing the output to go into an infinite loop.
...
carrie@ubuntu:/debugging$
```
#### [2-largest_number.c](https://github.com/Jerdah/alx-low_level_programming/blob/master/0x03-debugging/2-largest_number.c) 
